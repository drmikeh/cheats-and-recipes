...
In Hugo, a partial is a sugar-coated template. Normally a template reference has a path specified. Partials are different. Hugo searches for them along a defined search path. This makes it easier for end-users to override the theme's presentation.
...
These partials are already being processed by the file `themes/zafta/layouts/_default/baseof.html`.
